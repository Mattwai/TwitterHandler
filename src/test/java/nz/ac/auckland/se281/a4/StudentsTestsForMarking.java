...
//		StudentsTestsForMarking.Task3EquivalenceClassTest.class,
		...
		StudentsTestsForMarking.Task3BFSTest.class, StudentsTestsForMarking.Task3DFSTest.class,
...
public class StudentsTestsForMarking {
	...
	public static class Task3ReflexiveTest {
		...
		@Test
		public void T3_02_Reflexive_G1() {
			runTest("g1.txt", "-r");

		}

		@Test
		public void T3_04_Reflexive_G2() {
			runTest("g2.txt", "-r");

		}

		@Test
		public void T3_05_Reflexive_H1() {
			runTest("h1.txt", "-r");
	...
	public static class Task3SymmetricTest {
		...
		@Test
		public void T3_10_Symmetric_G1() {
			runTest("g1.txt", "-s");
		}

		@Test
		public void T3_12_Symmetric_G2() {
			runTest("g2.txt", "-s");
		}

		@Test
		public void T3_13_Symmetric_H1() {
			runTest("h1.txt", "-s");
